...
FILES := main.o flags.o difference.o chords.o integral.o derivative.o test.o

TRG := compile_main compile_flags compile_test compile_chords compile_integral compile_derivative compile_difference
